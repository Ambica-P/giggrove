...
const OnboardingDone = () => {
  ...
  useEffect(() => {
    ...
    }, 1000); // Confetti falls for 3 seconds, then stop recycling new ones
  ...
  return (
    <div className="max-w-lg mx-auto mt-12 p-6 relative">
      {/* Confetti animation */}
      {showConfetti && (
      ...
      <div className="relative z-20">
        ...
        <div className="flex mt-1">
          <Button className="flex-1 p-2 border border-gray-300 shadow-sm mr-2 hover:bg-gray-800">
            Find Talent
          </Button>
