...
const OnboardingForm: React.FC = () => {
    ...
    return (
        <div className="flex ">
            ...
            {/* Form Container */}
            <div className="flex-1 flex items-center justify-left p-6">
                <div className="w-full max-w-4xl  p-8">
                    ...
                    <div className="flex justify-between">
                        ...
                        >
                            <Link href="OnboardingForm">Back</Link>
                        </button>
                        <button
                            type="submit"
                            className="bg-logoBlue text-white px-4 py-2 rounded-md hover:bg-blue-400"
                        >
                            <Link href="InviteTeam">Next</Link>
                        </button>
                    </div>
                </div>
            </div>
